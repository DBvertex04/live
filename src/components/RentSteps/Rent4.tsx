...
const Step4: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Add form submission logic here (e.g., save data, navigate to next step)
    console.log({
      preferredTenants,
      selectedAreas,
      furnishing,
    ...
    // Example: Navigate to the next step or save data
    // You can use Next.js router or a state management solution
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 px-4 md:px-[300px] py-6">
            ...
            return (
              <div
                ...
                className={`flex items-center text-[14px] font-bold gap-2 px-4 py-2 rounded-full border cursor-pointer transition-all
                  ${isSelected ? "bg-[#1218280D] border-[#2450A0] text-[#2450A0]" : "bg-white border-gray-300 text-[#121828] hover:bg-[#f5faff]"}`}
                style={{ fontFamily: "Poppins, sans-serif" }}
              >
                <div
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-8 w-full px-4 py-3" style={{ fontFamily: "Poppins, sans-serif" }}>
      ...
      <div className="col-span-2 text-right pt-5">
        <button
          ...
          style={{ fontFamily: "Poppins, sans-serif", marginRight: "147px" }}
        >
          SAVE & NEXT
        </button>
      </div>
